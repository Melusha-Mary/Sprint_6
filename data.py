...
class DataForOrder:
    NAME = ['Мария', 'Николай', 'Дмитрий', 'Виктория', 'Алиса']
    SURNAME = ['Лешукова', 'Курочкин', 'Никулин', 'Жуков']
    ADDRESSE = ['улица Ленина, дом 5', 'Сиреневый бульвар, дом 2', 'улица Советская, дом 16']
    STATION = ['Аэропорт', 'Беговая', 'Домодедовская', 'Маяковская']
    RENTAL_PERIOD = ['сутки', 'двое суток', 'семь суток']
    COLOR = ['black', 'grey']
    COMMENT = ['приложите инструкцию', 'жду! жду! жду!', 'закрытый двор']